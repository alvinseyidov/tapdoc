...
class Doctor(models.Model):
    ...
    evde_muayine_endirim_faiz = models.CharField(verbose_name='Evdə Müayinə Endirim %-lə', max_length=256,null=True, blank=True)
    ...
    usaq_hekimi_endirim_faiz = models.CharField(verbose_name='Uşaq həkimi Endirim %-lə', max_length=256,null=True, blank=True)

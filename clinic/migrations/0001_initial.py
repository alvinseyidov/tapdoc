    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name_az', models.CharField(blank=True, max_length=256, null=True, verbose_name='Klinika Adı')),
                ('name_ru', models.CharField(blank=True, max_length=256, null=True, verbose_name='Klinika Adı')),
                ('fulltime', models.BooleanField(blank=True, null=True, verbose_name='24 saat işləyir')),
                ('senbe', models.BooleanField(blank=True, null=True, verbose_name='Şənbə işləyir')),
                ('bazar', models.BooleanField(blank=True, null=True, verbose_name='Bazar işləyir')),
                ('city', models.CharField(blank=True, choices=[('Bakı', 'Bakı'), ('Sumqayıt', 'Sumqayıt'), ('Gəncə', 'Gəncə'), ('Qəbələ', 'Qəbələ')], max_length=25, null=True, verbose_name='Şəhər')),
                ('address', models.CharField(blank=True, max_length=256, null=True, verbose_name='Klinika Ünvanı')),
                ('address_az', models.CharField(blank=True, max_length=256, null=True, verbose_name='Klinika Ünvanı')),
                ('address_ru', models.CharField(blank=True, max_length=256, null=True, verbose_name='Klinika Ünvanı')),
                ...
                ('description_az', ckeditor.fields.RichTextField(blank=True, null=True, verbose_name='Klinika Profil Məlumatı')),
                ('description_ru', ckeditor.fields.RichTextField(blank=True, null=True, verbose_name='Klinika Profil Məlumatı')),
                ('descriptionmeta', models.TextField(blank=True, max_length=256, null=True, verbose_name='Klinika Kard Məlumatı')),
                ('descriptionmeta_az', models.TextField(blank=True, max_length=256, null=True, verbose_name='Klinika Kard Məlumatı')),
                ('descriptionmeta_ru', models.TextField(blank=True, max_length=256, null=True, verbose_name='Klinika Kard Məlumatı')),
                ('descriptionmetadiaqnostika', models.TextField(blank=True, max_length=256, null=True, verbose_name='Diaqnostika Kard Məlumatı')),
                ('descriptionmetadiaqnostika_az', models.TextField(blank=True, max_length=256, null=True, verbose_name='Diaqnostika Kard Məlumatı')),
                ('descriptionmetadiaqnostika_ru', models.TextField(blank=True, max_length=256, null=True, verbose_name='Diaqnostika Kard Məlumatı')),
                ('image', models.ImageField(blank=True, default='defaultclinic.png', null=True, upload_to='', verbose_name='Profil Şəkli')),
                ...
                ('metro1_az', models.CharField(blank=True, max_length=256, null=True, verbose_name='Yaxın Olduğu 1-ci Metro')),
                ('metro1_ru', models.CharField(blank=True, max_length=256, null=True, verbose_name='Yaxın Olduğu 1-ci Metro')),
                ('metro1distance', models.CharField(blank=True, max_length=256, null=True, verbose_name='1-ci Metroya olan Məsafə')),
                ('metro1distance_az', models.CharField(blank=True, max_length=256, null=True, verbose_name='1-ci Metroya olan Məsafə')),
                ('metro1distance_ru', models.CharField(blank=True, max_length=256, null=True, verbose_name='1-ci Metroya olan Məsafə')),
                ('metro2', models.CharField(blank=True, max_length=256, null=True, verbose_name='Yaxın Olduğu 2-ci Metro')),
                ('metro2_az', models.CharField(blank=True, max_length=256, null=True, verbose_name='Yaxın Olduğu 2-ci Metro')),
                ('metro2_ru', models.CharField(blank=True, max_length=256, null=True, verbose_name='Yaxın Olduğu 2-ci Metro')),
                ('metro2distance', models.CharField(blank=True, max_length=256, null=True, verbose_name='2-ci Metroya olan Məsafə')),
                ('metro2distance_az', models.CharField(blank=True, max_length=256, null=True, verbose_name='2-ci Metroya olan Məsafə')),
                ('metro2distance_ru', models.CharField(blank=True, max_length=256, null=True, verbose_name='2-ci Metroya olan Məsafə')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('endirim_faizi', models.CharField(blank=True, max_length=64, null=True, verbose_name='Endirim Faizi')),
